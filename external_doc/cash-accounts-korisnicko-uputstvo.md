# Korisničko uputstvo za modul CashAccounts

## 1. Pregled modula

Modul `CashAccounts` služi za vođenje prometa po blagajnama i bankovnim računima, unos i obradu bankovnih izvoda, povezivanje izvoda sa otvorenim stavkama iz Glavne knjige, kao i za kreiranje i obradu platnih naloga.
...
Na taj način modul `CashAccounts` ostaje usklađen i sa bankarskim prometom i sa otvorenim stavkama u Glavnoj knjizi.
