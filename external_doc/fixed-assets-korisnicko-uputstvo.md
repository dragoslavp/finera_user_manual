# Korisničko uputstvo za modul FixedAssets

## 1. Pregled modula

Modul `FixedAssets` služi za vođenje evidencije osnovnih sredstava, njihovih klasa, lokacija, zaduženja po zaposlenima, promena vrednosti i obračuna amortizacije.
